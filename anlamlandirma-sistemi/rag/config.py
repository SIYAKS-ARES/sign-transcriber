...
# =============================================================================
# BASE PATHS (Flexible configuration for anlamlandirma-sistemi integration)
# =============================================================================
BASE_DIR = Path(__file__).parent  # rag/
ANLAMLANDIRMA_DIR = BASE_DIR.parent  # anlamlandirma-sistemi/
PROJECT_ROOT = ANLAMLANDIRMA_DIR.parent  # sign-transcriber/

# Vectorstore path - relative to anlamlandirma-sistemi or from environment
VECTORSTORE_PATH = Path(os.environ.get(
    "VECTORSTORE_PATH",
    str(ANLAMLANDIRMA_DIR / "vectorstore")
))

# TID Sozluk path - at project root or from environment
